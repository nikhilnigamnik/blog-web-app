  ...
  return (
    <div className="mx-auto max-w-7xl px-4">
      <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
        <div className="max-w-max rounded-full border bg-secondary p-1 px-3">
      ...
      {/* TEAM */}
      <div className="grid grid-cols-1 gap-4 gap-y-6 border-b border-border  py-12 pb-20 md:grid-cols-2 lg:grid-cols-4">
        {users.map((user) => (
      ...
      <div className="flex flex-col items-center gap-x-4 gap-y-4 py-16 md:flex-row">
        <div className="space-y-6">
          <p className="max-w-max rounded-full border bg-secondary p-1 px-3">
            Join our team &rarr;
          </p>
          ...
          <Button
            type="button"
            className="  px-3 py-2 text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
          >
            Join Now
          </Button>
        </div>
